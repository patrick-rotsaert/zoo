...
function(configure BUILD_DIR BUILD_SHARED_LIBS CMAKE_BUILD_TYPE)
	...
	if(VCPKG)
		if(NOT DEFINED ENV{VCPKG_ROOT})
			message(FATAL_ERROR "VCPKG_ROOT is not set. Install vcpkg and set the VCPKG_ROOT environment variable to its location.")
		endif()
		list(APPEND ARGS -DCMAKE_TOOLCHAIN_FILE=$ENV{VCPKG_ROOT}/scripts/buildsystems/vcpkg.cmake)
	endif()
