...
void ZOO_ZOOCOMMON_API       string_to_time_point(std::string_view in, time_point& out);
time_point ZOO_ZOOCOMMON_API string_to_time_point(std::string_view in);

void ZOO_ZOOCOMMON_API string_to_date(std::string_view in, date& out);
date ZOO_ZOOCOMMON_API string_to_date(std::string_view in);
...
void ZOO_ZOOCOMMON_API        time_of_day_to_string(const time_of_day& in, std::string& out);
std::string ZOO_ZOOCOMMON_API time_of_day_to_string(const time_of_day& in);
...
void ZOO_ZOOCOMMON_API        boost_date_to_string(const boost::gregorian::date& in, std::string& out);
std::string ZOO_ZOOCOMMON_API boost_date_to_string(const boost::gregorian::date& in);

void ZOO_ZOOCOMMON_API string_to_boost_time_duration(std::string_view in, boost::posix_time::time_duration& out);
boost::posix_time::time_duration ZOO_ZOOCOMMON_API string_to_boost_time_duration(std::string_view in);

void ZOO_ZOOCOMMON_API        boost_time_duration_to_string(const boost::posix_time::time_duration& in, std::string& out);
std::string ZOO_ZOOCOMMON_API boost_time_duration_to_string(const boost::posix_time::time_duration& in);

void ZOO_ZOOCOMMON_API        uuid_to_string(const boost::uuids::uuid& in, std::string& out);
std::string ZOO_ZOOCOMMON_API uuid_to_string(const boost::uuids::uuid& in);
