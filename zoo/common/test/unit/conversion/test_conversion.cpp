...
TEST(ConversionsTest, StringToDate)
{
	...
	EXPECT_EQ(string_to_date("20220318"), make_date(2022, 3, 18));
	EXPECT_EQ(string_to_date("08880318"), make_date(888, 3, 18));
	EXPECT_EQ(string_to_date("00880318"), make_date(88, 3, 18));
	EXPECT_EQ(string_to_date("00080318"), make_date(8, 3, 18));
	EXPECT_EQ(string_to_date("00000318"), make_date(0, 3, 18));
...
TEST(ConversionsTest, TimePointToIso8601)
{
	EXPECT_EQ(time_point_to_iso8601(make_time_point(2022, 3, 1, 3, 4, 5)), "2022-03-01T03:04:05Z");
	EXPECT_EQ(time_point_to_iso8601(make_time_point_micro(2022, 3, 1, 3, 4, 5.12345)), "2022-03-01T03:04:05.123450Z");
	EXPECT_EQ(time_point_to_iso8601(make_time_point_micro(2022, 3, 1, 3, 4, 5.123456)), "2022-03-01T03:04:05.123456Z");
	EXPECT_EQ(time_point_to_iso8601(make_time_point_micro(2022, 3, 1, 3, 4, 5.1234567)), "2022-03-01T03:04:05.123457Z");
}

TEST(ConversionsTest, TimePointToSql)
{
	EXPECT_EQ(time_point_to_sql(make_time_point(2022, 3, 1, 3, 4, 5)), "2022-03-01 03:04:05");
	EXPECT_EQ(time_point_to_sql(make_time_point_micro(2022, 3, 1, 3, 4, 5.12345)), "2022-03-01 03:04:05.123450");
	EXPECT_EQ(time_point_to_sql(make_time_point_micro(2022, 3, 1, 3, 4, 5.123456)), "2022-03-01 03:04:05.123456");
	EXPECT_EQ(time_point_to_sql(make_time_point_micro(2022, 3, 1, 3, 4, 5.1234567)), "2022-03-01 03:04:05.123457");
}
