...
#include <zoo/squid/mysql/detail/conversions.h>
...
{
	MYSQL_TIME out{};
	date_to_mysql_time(conversion::string_to_date("2023-06-25"), out);
...
{
	MYSQL_TIME out{};
	date_to_mysql_time(conversion::string_to_date("-123-06-25"), out);
...
{
	MYSQL_TIME out{};
	time_of_day_to_mysql_time(conversion::string_to_time_of_day("16:12:46"), out);
...
{
	MYSQL_TIME out{};
	time_of_day_to_mysql_time(conversion::string_to_time_of_day("16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_date("2023-06-25"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_time_of_day("16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_time_point("2023-06-25 16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_time_point("2023-06-25 16:12:46.123456+02:00"), out);
...
TEST(MysqlConversionsTest, FromMysqlTimeToDate)
{
	...
	EXPECT_EQ(out, conversion::string_to_date("2023-06-25"));
}
...
TEST(MysqlConversionsTest, FromMysqlTimeToTimeOfDay)
{
	...
	time_of_day out{};
	from_mysql_time(in, out);
	EXPECT_EQ(out.to_duration(), conversion::string_to_time_of_day("16:12:46.123456").to_duration());
}
...
TEST(MysqlConversionsTest, FromMysqlTimeToTimePoint)
{
	...
	time_point out{};
	from_mysql_time(in, out);
	EXPECT_EQ(out, conversion::string_to_time_point("2023-06-25 16:12:46.123456+01:00"));
}

TEST(MysqlConversionsTest, BoostDateToMysqlTime)
{
	MYSQL_TIME out{};
	boost_date_to_mysql_time(conversion::string_to_boost_date("2023-06-25"), out);
...
{
	MYSQL_TIME out{};
	boost_time_duration_to_mysql_time(conversion::string_to_boost_time_duration("16:12:46"), out);
...
{
	MYSQL_TIME out{};
	boost_time_duration_to_mysql_time(conversion::string_to_boost_time_duration("16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_boost_date("2023-06-25"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_boost_time_duration("16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_boost_ptime("2023-06-25 16:12:46.123456"), out);
...
{
	MYSQL_TIME out{};
	to_mysql_time(conversion::string_to_boost_ptime("2023-06-25 16:12:46.123456+02:00"), out);
...
TEST(MysqlConversionsTest, FromMysqlTimeToBoostDate)
{
	...
	from_mysql_time(in, out);
	EXPECT_EQ(out, conversion::string_to_boost_date("2023-06-25"));
}
...
TEST(MysqlConversionsTest, FromMysqlTimeToBoostTimeduration)
{
	...
	from_mysql_time(in, out);
	EXPECT_EQ(out, conversion::string_to_boost_time_duration("16:12:46.123456"));
}
...
TEST(MysqlConversionsTest, FromMysqlTimeToBoostPtime)
{
	...
	from_mysql_time(in, out);
	EXPECT_EQ(out, conversion::string_to_boost_ptime("2023-06-25 16:12:46.123456+01:00"));
}
