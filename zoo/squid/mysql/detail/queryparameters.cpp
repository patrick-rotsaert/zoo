...
void query_parameters::bind(MYSQL_STMT& statement)
{
	...
	{
		ZOO_THROW_EXCEPTION(error{ fmt::format(
		    "The number of parameters returned by mysql_stmt_param_count ({param_count}) differs from the number of parsed parameters ({binds})",
		    "param_count"_a = param_count,
