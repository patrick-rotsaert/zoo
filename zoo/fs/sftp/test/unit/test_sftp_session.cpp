...
protected:
	...
	auto run_test(issh_known_hosts::result knownhosts_verify_result,
...
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_NONE, SSH_AUTH_SUCCESS);
}

TEST_F(SftpSessionTests, test_setup_ssh_unknown_host_allowed)
{
	this->opts.allow_unknown_host_key = true;
	this->run_test(issh_known_hosts::result::UNKNOWN, SSH_AUTH_METHOD_NONE, SSH_AUTH_SUCCESS);
}
...
{
	this->opts.allow_unknown_host_key = true;
	this->run_test(issh_known_hosts::result::CHANGED, SSH_AUTH_METHOD_NONE, SSH_AUTH_SUCCESS);
}
...
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_NONE, SSH_AUTH_ERROR);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_password_success)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PASSWORD, SSH_AUTH_SUCCESS);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_password_fail)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PASSWORD, SSH_AUTH_ERROR);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_pubkey_success)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PUBLICKEY, SSH_AUTH_SUCCESS, SSH_AUTH_SUCCESS);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_try_pubkey_fail_error)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PUBLICKEY, SSH_AUTH_ERROR);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_try_pubkey_fail_denied)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PUBLICKEY, SSH_AUTH_DENIED);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_pubkey_fail_error)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PUBLICKEY, SSH_AUTH_SUCCESS, SSH_AUTH_ERROR);
}

TEST_F(SftpSessionTests, test_setup_ssh_user_auth_pubkey_fail_denied)
{
	this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_PUBLICKEY, SSH_AUTH_SUCCESS, SSH_AUTH_DENIED);
}

TEST_F(SftpSessionTests, test_setup_sftp)
{
	auto session = this->run_test(issh_known_hosts::result::KNOWN, SSH_AUTH_METHOD_NONE, SSH_AUTH_SUCCESS);
